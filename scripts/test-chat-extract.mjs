...
const CASES = [
  ...
  // 4차 독립 검증(2026-07-21) — 십/백 단위와 띄어쓴 숫자
  ["이십만원 이하로 알려줘", 200000, null, []],
  ["8 000 원 정도로", 8000, null, []],
  ["십만원", 100000, null, []],
  ["삼십만원", 300000, null, []],
  // 숫자가 아닌 것에서 금액을 만들지 않는다
  ["3번 출구 근처 맛집", null, null, []],
  ["24시간 하는 곳 있어?", null, null, []],
  ["2명이서 갈만한 곳 있어?", null, null, []],
  // 이슈 ⑧ — 합성어 뒤꼬리를 태그로 잡지 않는다 (어절 앞머리만)
  ["동해생선카레 있어?", null, null, []],
  ["교촌치킨 배달돼요?", null, null, []],
  ["명동칼국수 어디야", null, null, []],
