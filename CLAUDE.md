...
- 데모데이 **2026-07-25(토) 12:00~18:00**, 성균관대학교 자연과학캠퍼스 삼성학술정보관 48B108 (지하 1층 오디토리움)
  - **제출 마감**: 2026-07-24(금) 18:00까지 (builderwillow@gmail.com, dishonge@skku.edu 양쪽)
  - 제출물: 발표자료(서비스 명·문제 정의·데이터 플로우) + Live URL + 시연 영상(화면 녹화)
  - 발표: 7분 이내 (시연 영상 포함) + 질의응답 5분
  - 당일 오전 10시까지만 발표자료 수정 가능 (오탈자 수준)
  - 방학 중 학술정보관 17:00까지만 운영 → 퇴실 시 1층 정문(잔디밭 방향) 이용
  - 뚜껑 있는 음료 외 음식물 반입 금지
- 빌드업 마감 7/24. 남은 일정은 `ROADMAP.md`.
