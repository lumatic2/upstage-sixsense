...
| 13 | 20260721-landing-copy | 2026-07-22 | DR11 step-3 — 학식 카운터를 학식당 개수로 + 랜딩 아랫부분 문구 | 4/4 | done |
| 12 | 20260721-sitemap-current | 2026-07-22 | DR11 step-2 — 설계도 현행화(7건 대조) + 문구·라벨/문서 동기화 규약 신설 | 3/3 | done |
| 11 | 20260721-personalization-copy-truth | 2026-07-22 | DR11 step-1 — 폐기된 순서 개인화 설명 제거(4페이지 복제본 포함) | 4/4 | done |
| 10 | 20260721-personalization-redefined | 2026-07-21 | 개인화 재정의(ADR-0004) — 순서 가점 폐지·대화 기억 신설·카카오맵 길찾기 | 9/9 | done |
| 9 | 20260721-suggestion-chips | 2026-07-21 | 대화 칩 — Solar 생성 + 서버 실데이터 검증(최대 3개) · 고정 예산 칩 줄 제거 · 진입 칩은 오늘 데이터에서 | 8/8 | done |
